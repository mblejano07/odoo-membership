...
<div>
    <div class="mb-3 field-region pt-2">
        ...
        <select class="form-control form-control-sm" t-on-change="handleRegionChange" t-att-value="state.selectedRegion">
    ...
    <div class="mb-3 field-province pt-2">
        ...
        <select class="form-control form-control-sm" t-on-change="handleProvinceChange" t-att-value="state.selectedProvince">
    ...
    <div class="mb-3 field-city pt-2">
        ...
        <select class="form-control form-control-sm" t-on-change="handleCityChange" t-att-value="state.selectedCity">
